...
import {
  Equipment,
  unionToEquipment,
  unionListToEquipment,
} from '../../my-game/sample/equipment.js';
...
export class Monster {
  ...
  static addWeapons(
    builder: flatbuffers.Builder,
    weaponsOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(7, weaponsOffset, 0);
  }

  static createWeaponsVector(
    builder: flatbuffers.Builder,
