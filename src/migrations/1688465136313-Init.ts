...
export class Init1688465136313 implements MigrationInterface {
  name = 'Init1688465136313';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "role" varchar CHECK( "role" IN ('USER','ADMIN','MANAGER') ) NOT NULL DEFAULT ('USER'), "login" varchar NOT NULL, "password" varchar NOT NULL, "refreshToken" varchar, "isEnabled" boolean NOT NULL DEFAULT (1))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "fuel" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "name" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1), "outcomeId" integer, "supplyId" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "fuel_holder" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "fullName" varchar NOT NULL, "shortName" varchar, "isEnabled" boolean NOT NULL DEFAULT (1), "outcomeId" integer, "supplyId" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "refinery" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "fullName" varchar NOT NULL, "shortName" varchar, "isEnabled" boolean NOT NULL DEFAULT (1), "supplyId" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "tank" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "activeFuel" varchar CHECK( "activeFuel" IN ('PETROL') ) NOT NULL DEFAULT ('PETROL'), "sortIndex" integer NOT NULL, "calibrationTable" float NOT NULL, "totalVolume" float NOT NULL, "deathBalance" float NOT NULL, "temperature" float NOT NULL, "volume" float NOT NULL, "weight" float NOT NULL, "density" float NOT NULL, "level" integer NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1), "fuelId" integer, "fuelHolderId" integer, "refineryId" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "supply" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "driverName" varchar NOT NULL, "type" varchar CHECK( "type" IN ('PROCESS') ) NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "factByTank" float NOT NULL, "differenceWeight" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "levelBefore" float NOT NULL, "levelAfter" float NOT NULL, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer, "refineryId" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "vehicle" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "type" varchar CHECK( "type" IN ('TRUCK') ) NOT NULL DEFAULT ('TRUCK'), "carModel" varchar CHECK( "carModel" IN ('UNKNOWN') ) NOT NULL DEFAULT ('UNKNOWN'), "regNumber" varchar NOT NULL, "tanksVolume" text NOT NULL, "tanksCalibration" text NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1))`,
    );
    await queryRunner.query(
      `CREATE TABLE "outcome" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "status" varchar CHECK( "status" IN ('PROCESS') ) NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "counterBefore" float NOT NULL, "counterAfter" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "dispenserId" integer, "driverId" integer, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer)`,
    );
    await queryRunner.query(
      `CREATE TABLE "dispenser" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "sortIndex" integer NOT NULL, "currentCounter" float NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_fuel" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "name" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1), "outcomeId" integer, "supplyId" integer, CONSTRAINT "FK_7c394956bd9e93d0990c8d5ec63" FOREIGN KEY ("outcomeId") REFERENCES "outcome" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_e1207e159312382a885b555ee2c" FOREIGN KEY ("supplyId") REFERENCES "supply" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_fuel"("id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled", "outcomeId", "supplyId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled", "outcomeId", "supplyId" FROM "fuel"`,
    );
    await queryRunner.query(`DROP TABLE "fuel"`);
    await queryRunner.query(`ALTER TABLE "temporary_fuel" RENAME TO "fuel"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_fuel_holder" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "fullName" varchar NOT NULL, "shortName" varchar, "isEnabled" boolean NOT NULL DEFAULT (1), "outcomeId" integer, "supplyId" integer, CONSTRAINT "FK_f9db4e3c395ffadd66b09bba4e9" FOREIGN KEY ("outcomeId") REFERENCES "outcome" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_cd53f6662f6e0a3143e76ca29ad" FOREIGN KEY ("supplyId") REFERENCES "supply" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_fuel_holder"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "outcomeId", "supplyId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "outcomeId", "supplyId" FROM "fuel_holder"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_refinery" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "fullName" varchar NOT NULL, "shortName" varchar, "isEnabled" boolean NOT NULL DEFAULT (1), "supplyId" integer, CONSTRAINT "FK_bf57dbe99ffcd1ee20c579d12ef" FOREIGN KEY ("supplyId") REFERENCES "supply" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_refinery"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "supplyId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "supplyId" FROM "refinery"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_tank"("id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled", "fuelId", "fuelHolderId", "refineryId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled", "fuelId", "fuelHolderId", "refineryId" FROM "tank"`,
    );
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "tank"("id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled", "fuelId", "fuelHolderId", "refineryId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled", "fuelId", "fuelHolderId", "refineryId" FROM "temporary_tank"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "refinery"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "supplyId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "supplyId" FROM "temporary_refinery"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "fuel_holder"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "outcomeId", "supplyId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled", "outcomeId", "supplyId" FROM "temporary_fuel_holder"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "fuel"("id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled", "outcomeId", "supplyId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled", "outcomeId", "supplyId" FROM "temporary_fuel"`,
    );
