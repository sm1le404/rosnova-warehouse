...
export class AddTankStateInShift1692957834831 implements MigrationInterface {
    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `INSERT INTO "temporary_shift"("id", "createdAt", "updatedAt", "deletedAt", "startedAt", "closedAt", "userId", "startDispensersState", "finishDispensersState", "finishTankState") SELECT "id", "createdAt", "updatedAt", "deletedAt", "startedAt", "closedAt", "userId", "startDispensersState", "finishDispensersState" FROM "shift"`,
        );
