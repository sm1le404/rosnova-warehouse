...
/*eslint-disable*/
export class UpdateScheme1689137318689 implements MigrationInterface {
  name = 'UpdateScheme1689137318689';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_supply" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "type" varchar CHECK( "type" IN ('PROCESS','STRAIT','SUPPLY') ) NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "factByTank" float NOT NULL, "differenceWeight" float NOT NULL, "volumeBefore" float DEFAULT (0), "volumeAfter" float DEFAULT (0), "levelBefore" float DEFAULT (0), "levelAfter" float DEFAULT (0), "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer, "refineryId" integer, "driverId" integer, "vehicleState" text NOT NULL, CONSTRAINT "FK_7b8bb1f975f7935edc70c729cbf" FOREIGN KEY ("driverId") REFERENCES "driver" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1611bfff8ef7b87a361288b94bb" FOREIGN KEY ("vehicleId") REFERENCES "vehicle" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_2cdbd044860396c3498b6e9a145" FOREIGN KEY ("tankId") REFERENCES "tank" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_67ad1d4a093b287f7fe7b21ffe7" FOREIGN KEY ("shiftId") REFERENCES "shift" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_e4e0755fa0909eb5915a6bd66d6" FOREIGN KEY ("fuelId") REFERENCES "fuel" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_29e4e104af3986e50b40a0e152e" FOREIGN KEY ("fuelHolderId") REFERENCES "fuel_holder" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_f9e8cae118517b0dc1c9ded7d5d" FOREIGN KEY ("refineryId") REFERENCES "refinery" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_supply"("id", "createdAt", "updatedAt", "deletedAt", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "differenceWeight", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId", "driverId", "vehicleState") SELECT "id", "createdAt", "updatedAt", "deletedAt", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "differenceWeight", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId", "driverId", "vehicleState" FROM "supply"`,
    );
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "outcome"("id", "createdAt", "updatedAt", "deletedAt", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId", "vehicleState") SELECT "id", "createdAt", "updatedAt", "deletedAt", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId", "vehicleState" FROM "temporary_outcome"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "supply"("id", "createdAt", "updatedAt", "deletedAt", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "differenceWeight", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId", "driverId", "vehicleState") SELECT "id", "createdAt", "updatedAt", "deletedAt", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "differenceWeight", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId", "driverId", "vehicleState" FROM "temporary_supply"`,
    );
