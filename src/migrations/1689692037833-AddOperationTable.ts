...
/*eslint-disable*/
export class AddOperationTable1689692037833 implements MigrationInterface {
  name = 'AddOperationTable1689692037833';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "temporary_user" RENAME TO "user"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_operation" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "updatedAt" integer NOT NULL DEFAULT (strftime('%s', 'now')), "deletedAt" datetime, "type" varchar CHECK( "type" IN ('outcome','supply','strait','return') ) NOT NULL, "status" varchar CHECK( "status" IN ('created','started','progress','interrupted','stopped','finished') ) NOT NULL DEFAULT ('created'), "vehicleState" text NOT NULL, "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "counterBefore" float DEFAULT (0), "counterAfter" float DEFAULT (0), "volumeBefore" float DEFAULT (0), "volumeAfter" float DEFAULT (0), "factByTank" float NOT NULL, "differenceWeight" float NOT NULL, "levelBefore" float DEFAULT (0), "levelAfter" float DEFAULT (0), "dispenserId" integer, "driverId" integer, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuel" text NOT NULL, "fuelHolder" text NOT NULL, "refinery" text NOT NULL, CONSTRAINT "FK_44a506978936572278194b22c22" FOREIGN KEY ("dispenserId") REFERENCES "dispenser" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_4fe00161ef48138bfa3f434d1e2" FOREIGN KEY ("driverId") REFERENCES "driver" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_289c58cdde3f9e5e7d1c9111b6f" FOREIGN KEY ("vehicleId") REFERENCES "vehicle" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_7c627c969c9eeccceb4b290806c" FOREIGN KEY ("tankId") REFERENCES "tank" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_0fe8d164f8e00199fff3a1ab00e" FOREIGN KEY ("shiftId") REFERENCES "shift" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_operation"("id", "createdAt", "updatedAt", "deletedAt", "type", "status", "vehicleState", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "factByTank", "differenceWeight", "levelBefore", "levelAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuel", "fuelHolder", "refinery") SELECT "id", "createdAt", "updatedAt", "deletedAt", "type", "status", "vehicleState", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "factByTank", "differenceWeight", "levelBefore", "levelAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuel", "fuelHolder", "refinery" FROM "operation"`,
    );
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "operation"("id", "createdAt", "updatedAt", "deletedAt", "type", "status", "vehicleState", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "factByTank", "differenceWeight", "levelBefore", "levelAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuel", "fuelHolder", "refinery") SELECT "id", "createdAt", "updatedAt", "deletedAt", "type", "status", "vehicleState", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "factByTank", "differenceWeight", "levelBefore", "levelAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuel", "fuelHolder", "refinery" FROM "temporary_operation"`,
    );
