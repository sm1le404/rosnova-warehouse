...
export class UpdateTables1687860858215 implements MigrationInterface {
  name = 'UpdateTables1687860858215';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "temporary_tank" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "activeFuel" varchar NOT NULL DEFAULT ('PETROL'), "sortIndex" integer NOT NULL, "calibrationTable" float NOT NULL, "totalVolume" float NOT NULL, "deathBalance" float NOT NULL, "temperature" float NOT NULL, "volume" float NOT NULL, "weight" float NOT NULL, "density" float NOT NULL, "level" integer NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1))`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_tank"("id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled" FROM "tank"`,
    );
    await queryRunner.query(`DROP TABLE "tank"`);
    await queryRunner.query(`ALTER TABLE "temporary_tank" RENAME TO "tank"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_supply" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "driverName" varchar NOT NULL, "type" varchar NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "factByTank" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "levelBefore" float NOT NULL, "levelAfter" float NOT NULL)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_supply"("id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter") SELECT "id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter" FROM "supply"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "role" varchar CHECK( "role" IN ('USER','ADMIN') ) NOT NULL DEFAULT ('USER'), "login" varchar NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1), "refreshToken" varchar)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_user"("id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled" FROM "user"`,
    );
    await queryRunner.query(`DROP TABLE "user"`);
    await queryRunner.query(`ALTER TABLE "temporary_user" RENAME TO "user"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_shift" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "startedAt" integer NOT NULL, "closedAt" integer NOT NULL, "userId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_shift"("id", "createdAt", "updatedAt", "deletedAt", "startedAt", "closedAt") SELECT "id", "createdAt", "updatedAt", "deletedAt", "startedAt", "closedAt" FROM "shift"`,
    );
    await queryRunner.query(`DROP TABLE "shift"`);
    await queryRunner.query(`ALTER TABLE "temporary_shift" RENAME TO "shift"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_measurement" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "volume" float NOT NULL, "weight" float NOT NULL, "density" float NOT NULL, "level" integer NOT NULL, "shiftId" integer, "tankId" integer, "temperature" float NOT NULL, CONSTRAINT "REL_9db39d4bd115c73809964f0b81" UNIQUE ("shiftId"), CONSTRAINT "FK_92f5563f093215be4ca1005b0ac" FOREIGN KEY ("tankId") REFERENCES "tank" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_9db39d4bd115c73809964f0b81f" FOREIGN KEY ("shiftId") REFERENCES "shift" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_fuel" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "name" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1), "tankId" integer, "outcomeId" integer, "supplyId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_fuel"("id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled" FROM "fuel"`,
    );
    await queryRunner.query(`DROP TABLE "fuel"`);
    await queryRunner.query(`ALTER TABLE "temporary_fuel" RENAME TO "fuel"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_fuel_holder" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "fullName" varchar NOT NULL, "shortName" varchar, "isEnabled" boolean NOT NULL DEFAULT (1), "tankId" integer, "outcomeId" integer, "supplyId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_fuel_holder"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled" FROM "fuel_holder"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_refinery" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "fullName" varchar NOT NULL, "shortName" varchar, "isEnabled" boolean NOT NULL DEFAULT (1), "tankId" integer, "supplyId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_refinery"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled" FROM "refinery"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_supply" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "driverName" varchar NOT NULL, "type" varchar NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "factByTank" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "levelBefore" float NOT NULL, "levelAfter" float NOT NULL, "differenceWeight" float NOT NULL, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer, "refineryId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_supply"("id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter") SELECT "id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter" FROM "supply"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_outcome" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "status" varchar NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "counterBefore" float NOT NULL, "counterAfter" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "dispenserId" integer, "driverId" integer, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_outcome"("id", "createdAt", "updatedAt", "deletedAt", "status", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter") SELECT "id", "createdAt", "updatedAt", "deletedAt", "status", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter" FROM "outcome"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_user"("id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled", "refreshToken") SELECT "id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled", "refreshToken" FROM "user"`,
    );
    await queryRunner.query(`DROP TABLE "user"`);
    await queryRunner.query(`ALTER TABLE "temporary_user" RENAME TO "user"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_supply"("id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "differenceWeight", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "differenceWeight", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId" FROM "supply"`,
    );
    await queryRunner.query(`DROP TABLE "supply"`);
    await queryRunner.query(
      `ALTER TABLE "temporary_supply" RENAME TO "supply"`,
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_vehicle" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "type" varchar CHECK( "type" IN ('TRUCK') ) NOT NULL DEFAULT ('TRUCK'), "carModel" varchar CHECK( "carModel" IN ('UNKNOWN') ) NOT NULL DEFAULT ('UNKNOWN'), "regNumber" varchar NOT NULL, "tanksVolume" text NOT NULL, "tanksCalibration" text NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "outcome" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "status" varchar NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "counterBefore" float NOT NULL, "counterAfter" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "dispenserId" integer, "driverId" integer, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "outcome"("id", "createdAt", "updatedAt", "deletedAt", "status", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "status", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter", "dispenserId", "driverId", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId" FROM "temporary_outcome"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "vehicle" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "type" varchar NOT NULL DEFAULT ('TRUCK'), "carModel" varchar NOT NULL DEFAULT ('UNKNOWN'), "regNumber" varchar NOT NULL, "tanksVolume" float NOT NULL, "tanksCalibration" float NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "supply" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "driverName" varchar NOT NULL, "type" varchar NOT NULL DEFAULT ('PROCESS'), "numberTTN" integer NOT NULL, "docVolume" float NOT NULL, "docWeight" float NOT NULL, "docDensity" float NOT NULL, "docTemperature" float NOT NULL, "factVolume" float NOT NULL, "factWeight" float NOT NULL, "factDensity" float NOT NULL, "factByTank" float NOT NULL, "volumeBefore" float NOT NULL, "volumeAfter" float NOT NULL, "levelBefore" float NOT NULL, "levelAfter" float NOT NULL, "differenceWeight" float NOT NULL, "vehicleId" integer, "tankId" integer, "shiftId" integer, "fuelId" integer, "fuelHolderId" integer, "refineryId" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "supply"("id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "differenceWeight", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId") SELECT "id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter", "differenceWeight", "vehicleId", "tankId", "shiftId", "fuelId", "fuelHolderId", "refineryId" FROM "temporary_supply"`,
    );
    ...
    await queryRunner.query(
      `INSERT INTO "tank"("id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "activeFuel", "sortIndex", "calibrationTable", "totalVolume", "deathBalance", "temperature", "volume", "weight", "density", "level", "isEnabled" FROM "temporary_tank"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_tank"`);
    await queryRunner.query(`ALTER TABLE "user" RENAME TO "temporary_user"`);
    await queryRunner.query(
      `CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "role" varchar CHECK( "role" IN ('USER','ADMIN') ) NOT NULL DEFAULT ('USER'), "login" varchar NOT NULL, "password" varchar NOT NULL, "isEnabled" boolean NOT NULL DEFAULT (1), "refreshToken" varchar)`,
    );
    await queryRunner.query(
      `INSERT INTO "user"("id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled", "refreshToken") SELECT "id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled", "refreshToken" FROM "temporary_user"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_user"`);
    await queryRunner.query(`ALTER TABLE "event" RENAME TO "temporary_event"`);
    await queryRunner.query(
      `CREATE TABLE "event" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "createdAt" integer NOT NULL DEFAULT (datetime('now')), "updatedAt" integer NOT NULL DEFAULT (datetime('now')), "deletedAt" integer, "name" varchar NOT NULL, "type" varchar NOT NULL DEFAULT ('PROCESS'), "collection" varchar NOT NULL DEFAULT ('PROCESS'), "dataBefore" varchar NOT NULL, "dataAfter" varchar NOT NULL, "shiftId" integer, CONSTRAINT "FK_b73505b6ca6ee9d0207ab350cfc" FOREIGN KEY ("shiftId") REFERENCES "shift" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "outcome"("id", "createdAt", "updatedAt", "deletedAt", "status", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter") SELECT "id", "createdAt", "updatedAt", "deletedAt", "status", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "counterBefore", "counterAfter", "volumeBefore", "volumeAfter" FROM "temporary_outcome"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_outcome"`);
    await queryRunner.query(
      `ALTER TABLE "supply" RENAME TO "temporary_supply"`,
    ...
    await queryRunner.query(
      `INSERT INTO "supply"("id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter") SELECT "id", "createdAt", "updatedAt", "deletedAt", "driverName", "type", "numberTTN", "docVolume", "docWeight", "docDensity", "docTemperature", "factVolume", "factWeight", "factDensity", "factByTank", "volumeBefore", "volumeAfter", "levelBefore", "levelAfter" FROM "temporary_supply"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_supply"`);
    await queryRunner.query(
      `ALTER TABLE "refinery" RENAME TO "temporary_refinery"`,
    ...
    await queryRunner.query(
      `INSERT INTO "refinery"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled" FROM "temporary_refinery"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_refinery"`);
    await queryRunner.query(
      `ALTER TABLE "fuel_holder" RENAME TO "temporary_fuel_holder"`,
    ...
    await queryRunner.query(
      `INSERT INTO "fuel_holder"("id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "fullName", "shortName", "isEnabled" FROM "temporary_fuel_holder"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_fuel_holder"`);
    await queryRunner.query(`ALTER TABLE "fuel" RENAME TO "temporary_fuel"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "fuel"("id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "name", "isEnabled" FROM "temporary_fuel"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_fuel"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "shift"("id", "createdAt", "updatedAt", "deletedAt", "startedAt", "closedAt") SELECT "id", "createdAt", "updatedAt", "deletedAt", "startedAt", "closedAt" FROM "temporary_shift"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_shift"`);
    await queryRunner.query(`ALTER TABLE "user" RENAME TO "temporary_user"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "user"("id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled") SELECT "id", "createdAt", "updatedAt", "deletedAt", "role", "login", "password", "isEnabled" FROM "temporary_user"`,
    );
    await queryRunner.query(`DROP TABLE "temporary_user"`);
    await queryRunner.query(
      `ALTER TABLE "supply" RENAME TO "temporary_supply"`,
